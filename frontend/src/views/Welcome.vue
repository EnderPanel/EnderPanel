      ...
      <div class="glass rounded-2xl p-8 md:p-12 shadow-2xl">
        <transition name="slide" mode="out-in">
          ...
          <div v-else-if="step === 2" key="features" class="text-center">
            ...
            <h2 class="text-2xl font-bold mb-2">Connect with Playit</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Get a free public address for your server — no port forwarding needed.</p>

            <div class="flex flex-col gap-3 mb-8 text-left">
              <div class="flex gap-4 bg-gray-50 dark:bg-white/5 rounded-xl p-4 items-start">
                <div class="w-8 h-8 shrink-0 bg-mc-accent/20 text-mc-accent rounded-lg flex items-center justify-center font-bold text-sm">1</div>
                <div>
                  <p class="font-semibold text-sm mb-0.5">Open the Playit setup page</p>
                  <p class="text-sm text-gray-500 dark:text-gray-400">Go to your server's <span class="font-medium text-gray-700 dark:text-gray-300">Playit</span> tab, click <span class="font-medium text-gray-700 dark:text-gray-300">Connect</span>, then click <span class="font-medium text-gray-700 dark:text-gray-300">Open Setup Page</span>.</p>
                </div>
              </div>
              <div class="flex gap-4 bg-gray-50 dark:bg-white/5 rounded-xl p-4 items-start">
                <div class="w-8 h-8 shrink-0 bg-mc-accent/20 text-mc-accent rounded-lg flex items-center justify-center font-bold text-sm">2</div>
                <div>
                  <p class="font-semibold text-sm mb-0.5">Get your setup code</p>
                  <p class="text-sm text-gray-500 dark:text-gray-400">On the Playit website select <span class="font-medium text-gray-700 dark:text-gray-300">Other</span>, copy the one-time code, and paste it into the box in the panel.</p>
                </div>
              </div>
              <div class="flex gap-4 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl p-4 items-start border border-emerald-200 dark:border-emerald-500/20">
                <div class="w-8 h-8 shrink-0 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-lg flex items-center justify-center font-bold text-sm">✓</div>
                <div>
                  <p class="font-semibold text-sm mb-0.5 text-emerald-700 dark:text-emerald-300">You're done!</p>
                  <p class="text-sm text-emerald-600/80 dark:text-emerald-400/80">Your server gets a free public address. Share it with friends and enjoy!</p>
                </div>
              </div>
            </div>
