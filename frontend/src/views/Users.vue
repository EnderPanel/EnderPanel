<template>
  <div class="max-w-6xl mx-auto px-6 py-8 dqs-page-shell dqs-users-page">
    <div class="flex justify-between items-center mb-8 dqs-page-header">
      <div>
        <p class="dqs-overline">Operations</p>
        <h1 class="text-2xl font-bold dqs-page-title">User Management</h1>
      </div>
    ...
    <div v-else class="card overflow-hidden dqs-table-card">
      <table class="w-full dqs-data-table">
    ...
    <transition name="modal">
      <div v-if="showEdit" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 dqs-modal-overlay" @click.self="showEdit = false">
