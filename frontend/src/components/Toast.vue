<template>
  ...
  <transition name="modal">
    <div v-if="confirmModal.show" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9998] p-4" @click.self="cancelConfirm">
      <div class="glass rounded-2xl p-6 w-full max-w-md scale-in">
