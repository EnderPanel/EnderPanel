...
class Server(Base):
    ...
    swap_mb: Mapped[int] = Column(Integer, default=512)
    ...
    public_domain_enabled: Mapped[bool] = Column(Boolean, default=False)
    public_domain_subdomain: Mapped[Optional[str]] = Column(String(63), nullable=True)
    public_domain: Mapped[Optional[str]] = Column(String(255), nullable=True)
    playit_enabled: Mapped[bool] = Column(Boolean, default=False)
    playit_tunnel_id: Mapped[Optional[str]] = Column(String(128), nullable=True)
    playit_domain: Mapped[Optional[str]] = Column(String(255), nullable=True)
